...
static bool TestEllipseUtils_1(const COptions& opts)
{
	...
	bool isCorrect =
		fabs(e.x0 - 960.44263945130331) < 2 * 0.001 &&
		fabs(e.y0 - 486.67764874797450) < 2 * 0.001 &&
		fabs(e.a - 490.00254257630809) < 2 * 0.001 &&
		fabs(e.b - 440.87372019871373) < 2 * 0.001 &&
		fabs(e.theta - (-1.2640157348100098)) < 2 * 0.001;
